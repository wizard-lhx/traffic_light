...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, HORIZONTAL_R_Pin|HORIZONTAL_Y_Pin|HORIZONTAL_G_Pin|VERTICAL_R_Pin
                          |VERTICAL_Y_Pin|VERTICAL_G_Pin|HORIZONTAL_LG_Pin|VERTICAL_LG_Pin
  ...
  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           ...
                           PAPin PAPin */
  GPIO_InitStruct.Pin = HORIZONTAL_R_Pin|HORIZONTAL_Y_Pin|HORIZONTAL_G_Pin|VERTICAL_R_Pin
                          |VERTICAL_Y_Pin|VERTICAL_G_Pin|HORIZONTAL_LG_Pin|VERTICAL_LG_Pin
                          |PEOPLE_R_Pin|PEOPLE_G_Pin;
  ...
  GPIO_InitStruct.Pin = VERTICAL_SET_Pin|HORIZONTAL_SET_Pin;
